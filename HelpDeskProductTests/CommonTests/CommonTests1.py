...
class CommonTests1(BaseTest):
    ...
    def login_as_admin(self):
        try:
            ...
            # get_driver is missing in this file
            ...
            print(e)
            # Wrong Package used, can use built functions 
    ...
    def test_case_1(self):
        try:
            ...
            # Wrong usage of function calls in below lines
            self.hpAdminPortalTest1 = self.hploginpage.validate_pending_tickets_title()
...
if __name__ == "__main__":
    ...
    # Missing function in the existing code
    common_tests.setup()
